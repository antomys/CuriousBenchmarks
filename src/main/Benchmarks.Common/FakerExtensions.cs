...
public static class FakerExtensions
{
    ...
    /// <param name="count">Generation count.</param>
    public static Dictionary<TKey, TValue> GetDictionary<TKey, TValue>(this Faker faker, Func<Faker,TKey> keyAction, Func<Faker,TValue> valueAction, int count) where TKey : notnull
    {
