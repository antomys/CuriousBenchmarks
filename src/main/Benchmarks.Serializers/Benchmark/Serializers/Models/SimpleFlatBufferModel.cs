...
public struct SimpleFlatBufferModel : IFlatbufferObject
{
  ...
  public static Offset<Benchmark.Serializers.Models.SimpleFlatBufferModel> CreateSimpleFlatBufferModel(FlatBufferBuilder builder,
      int test_int = 0,
  ...
  public static Offset<Benchmark.Serializers.Models.SimpleFlatBufferModel> EndSimpleFlatBufferModel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Benchmark.Serializers.Models.SimpleFlatBufferModel>(o);
  }
}
