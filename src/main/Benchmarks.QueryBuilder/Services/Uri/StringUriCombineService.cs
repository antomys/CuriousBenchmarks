...
public static class StringUriCombineService
{
    ...
    public static System.Uri UriSwitch(string path, string relative)
    {
        ...
        if (path.Length is 0) throw new UriFormatException();
    ...
    public static System.Uri UriBuilderTryCreate(string absoluteUri, string relativePath)
    {
        ...
        if (!System.Uri.TryCreate(baseUri.Uri, relativePath, out var newUri)) throw new UriFormatException("Unable to combine specified url values");
    ...
    public static System.Uri UriCombineCached(string absoluteUri, string relativePath)
    {
        ...
        if (string.IsNullOrEmpty(absoluteUri)) throw new ArgumentNullException(absoluteUri);
    ...
    {
        if (string.IsNullOrEmpty(absoluteUri)) throw new ArgumentNullException(nameof(absoluteUri));
