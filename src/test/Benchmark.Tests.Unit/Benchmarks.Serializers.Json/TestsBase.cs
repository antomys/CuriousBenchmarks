...
public static class TestsBase
{
    ...
    private readonly static string TestString = BuildString(TestModels, isIsoTimeSpan : false);
    
    private readonly static string TestUtf8JsonString = BuildString(TestModels, isIsoTimeSpan : false, isUtf8 : true);
    
    private readonly static string TestJilString = BuildString(TestModels, isIsoTimeSpan: true);
