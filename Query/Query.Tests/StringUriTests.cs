...
public sealed class StringUriTests
{
    ...
    private static readonly Uri BaseUriDelimiter = new("https://localhost/");
    
    private static readonly string BaseUriString = BaseUri.AbsoluteUri;
    private static readonly string BaseUriDelimiterString = BaseUriDelimiter.AbsoluteUri;
