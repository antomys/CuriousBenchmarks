...
namespace LinqGroupByDistinct.Benchmarks.Services;
...
public static class LinqService
{
    ...
    public static IEnumerable<InnerModel> GroupByTake(this IEnumerable<SimpleModel> testModelsList, Dictionary<string, InnerModel> innerTestModels, string innerTestModelConstId)
    {
    ...
    /// <param name="innerTestModelConstId">Specific string id, to be retrieved by.</param>
    /// <returns>Collection of <see cref="InnerModel"/>.</returns>
    public static IEnumerable<InnerModel> DistinctByTake(this IEnumerable<SimpleModel> testModelsList, Dictionary<string, InnerModel> innerTestModels, string innerTestModelConstId)
    {
        return testModelsList
    ...
    /// <param name="innerTestModelConstId">Specific string id, to be retrieved by.</param>
    /// <returns>Collection of <see cref="InnerModel"/>.</returns>
    public static IEnumerable<InnerModel> DistinctTake(this IEnumerable<SimpleModel> testModelsList, Dictionary<string, InnerModel> innerTestModels, string innerTestModelConstId)
    {
        return testModelsList
