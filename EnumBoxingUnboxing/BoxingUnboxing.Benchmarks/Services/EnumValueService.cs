...
public static class EnumValueService
{
    ...
    /// <summary>
    ///     Getting integer value from enum by casting firstly <see cref="TestEnum"/> to <see cref="int"/> and then using 'ToString'.
    /// </summary>
    /// <param name="testEnum"><see cref="TestEnum"/>.</param>
    /// <returns>Value of Enum.</returns>
    ...
    /// <summary>
    ///     Getting integer value from enum using method from <see cref="EnumExtensions"/> to get int value <see cref="EnumExtensions.CustomGetValue"/>.
    /// </summary>
    /// <param name="testEnum"><see cref="TestEnum"/>.</param>
    /// <returns>Value of Enum.</returns>
    public static string CustomGetValue(this TestEnum testEnum)
    {
        return EnumExtensions.CustomGetValue(testEnum).ToString();
    }
}