...
public static class MvcOptionsExtension
{
    ...
    private static void Configure<TResolver>(IServiceCollection serviceCollection) where TResolver : IJsonFormatterResolver<byte, TResolver>, new() => serviceCollection.Configure((Action<MvcOptions>) (config =>
    {
